...
### BCC DHCP项目 
项目主要是用BCC替换掉原cisco CNR系统，BCC基于VMware  ESXi虚拟平台Centos7操作系统，作为主要实施人，我完成了整个系统架构、网络规划、系统配置、业务割接等工作。并完成了BCC系统部署的标准化流程，以便大规模部署。在该系统上线后，DHCP性能经压力测试提升5倍以上，服务器虚拟机由122台减少到20台，承载了整个重庆有线近400W租约。在后期我还针对BCC搭建了cacti和zabbix监控系统，实现自动化监控，自动化运维。

### WAG WLAN项目

项目针对公司原WLAN业务无实名认证，WAG通过建立GRE隧道与AP通信，同时采用TR069协议自动给AP下发配置，终端通过短信认证的方式实现实名认证。WAG基于NFV架构，采用KVM虚拟平台，转发与控制平面分离，采用1+1热备做HA，单台x86服务器能承载1W AP和10W用户。作为项目负责人，我完成了整个系统架构、网络规划、系统配置，以及测试验证和业务割接等工作。系统上线后满足了网监实名认证、审计的要求，同时WAG+AP架构成本比AC+AP架构降低了接近一半，帮助公司顺利发展WLAN业务。
...
- 熟悉前端H5、CSS、js等网站开发技术，熟悉后端node，Apache，Nginx，Caddy，数据库MYSQL、MongoDB等相关技术
