...
"Chart Files (_.xlc)|_.xlc|Worksheet Files (_.xls)|_.xls|Data Files (_.xlc;_.xls)|_.xlc; _.xls|All Files (_._)|_._||";文件类型说明和扩展名间用 | 分隔，同种类型文件的扩展名间可以用 ; 分割，每种文件类型间用 | 分隔，末尾用 || 指明。
