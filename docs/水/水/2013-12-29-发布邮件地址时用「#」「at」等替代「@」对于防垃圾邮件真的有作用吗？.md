...
【3】
以及，有一个研究（ http:// techblog.tilllate.com/2 008/07/20/ten-methods-to-obfuscate-e-mail-addresses-compared/ ）对比了9种隐藏邮件的方法( http:// ch.tilllate.com/061101\_ emailtest.php )，包括上面提到的几种方法，以及一些CSS的tricks。可以看到用ATs和DOTs的效果惊人的好。
